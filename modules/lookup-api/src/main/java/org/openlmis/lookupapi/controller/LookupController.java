...
public class LookupController {
    ...
    @RequestMapping(value = "/rest-api/lookup/save-losses-adjustments-types", method = RequestMethod.POST, headers = ACCEPT_JSON)
    public ResponseEntity saveLossesAdjustmentsTypes(@RequestBody AdjustmentType adjustmentsType) {
        lookupService.InsertLossesAndAdjustment(adjustmentsType);
        return RestResponse.response("adjustment","inserted succesifully" );
    }
