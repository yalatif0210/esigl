...
public class LookupService {
  ...
  @Transactional
  public void InsertLossesAndAdjustment(AdjustmentType adjustmentType ) {

    AdjustmentType type = adjustmentTypeReportMapper.getAdjustmentByName(adjustmentType.getName());

    if(type != null) {
      adjustmentTypeReportMapper.update(adjustmentType);
    } else {
       adjustmentTypeReportMapper.insert(adjustmentType);
    }
