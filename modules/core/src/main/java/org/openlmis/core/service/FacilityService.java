...
public class FacilityService {
  ...
  @Autowired
  ELMISInterfaceRepository elmisInterfaceRepository;
  ...
  public Facility getById(Long id) {
    ...
    if(facility != null)
    {
      ...
      String dhis2Id = elmisInterfaceRepository.getDHIS2IdByFacilityCode(facility.getCode());
      facility.setAddress1(dhis2Id);
  ...
  public List<FacilityLight> getFacilityListLight() {
    return facilityRepository.getFacilityListLight();
  }
}
