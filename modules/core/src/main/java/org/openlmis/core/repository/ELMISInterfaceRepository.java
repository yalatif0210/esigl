...
public class ELMISInterfaceRepository {
  ...
  public String getDataSageByProgramCode(String code, String sageConfig) {
        return mapper.getDataSageByProgramCode(code, sageConfig);
  }

  public String getDHIS2IdByFacilityCode(String facilityCode) {
        return mapper.getDHIS2IdByFacilityCode(facilityCode);
  }
}
