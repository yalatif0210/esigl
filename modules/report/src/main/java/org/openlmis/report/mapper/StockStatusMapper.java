...
public interface StockStatusMapper {
  ...
  @Select("select *, openingBalance beginningBalance, received quantityReceived, issues quantityDispensed,\n" +
      "stockOnHand stockInHand, stockOutDays, quantityApproved, quantityRequested, productname as product, " +
      "districtname district, periodname reportPeriodName, reportyear reportedYear, reportmonth reportedMonth, " +
      "esigl_code esiglCode, region_name region, id_DHIS2 idDhis2 " +
