...
function CreateNonFullSupplyController($scope, messageService) {
  ...
  $scope.addNonFullSupplyProductsByCategory = function () {
    ...
    var rnrLineItem = new RegularRnrLineItem($scope.newNonFullSupply, $scope.rnr.period.numberOfMonths, $scope.programRnrColumnList, $scope.rnr.status, $scope.rnr.period, $scope.rnr.facility);
