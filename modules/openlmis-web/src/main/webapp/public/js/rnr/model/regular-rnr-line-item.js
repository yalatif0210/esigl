...
var RegularRnrLineItem = base2.Base.extend({
  ...
  constructor: function (lineItem, numberOfMonths, programRnrColumnList, rnrStatus, period, facility) {
  ...
  addLossAndAdjustment: function (newLossAndAdjustment) {
    if (isUndefined(newLossAndAdjustment.facility)) {
      var object = {};
      object.id = this.facility.id;
      object.name = this.facility.name;
      object.district = this.facility.geographicZone.name;
      object.code = this.facility.code;
      newLossAndAdjustment.facility = object;
    }

    var lossAndAdjustment = new LossAndAdjustment(newLossAndAdjustment);

    newLossAndAdjustment.facility = undefined;
    newLossAndAdjustment.type = undefined;
    newLossAndAdjustment.quantity = undefined;
    newLossAndAdjustment.reason = undefined;
