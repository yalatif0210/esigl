...
public class RequisitionControllerTest {
  ...
  public void shouldReturnListOfApprovedRequisitionsForConvertingToOrder() {
    ...
    when(requisitionService.getNumberOfPagesOfApprovedRequisitionsForCriteria(searchType, searchVal, null, null, USER_ID,
      RightName.CONVERT_TO_ORDER)).thenReturn(1);
    when(requisitionService.getApprovedRequisitionsForCriteriaAndPageNumber(searchType, searchVal, null, null, pageNumber,
    ...
    ResponseEntity<OpenLmisResponse> responseEntity = controller.listForConvertToOrder(searchType, searchVal, null, null, pageNumber, sortBy, sortDirection, request);

    verify(requisitionService).getApprovedRequisitionsForCriteriaAndPageNumber(searchType, searchVal, null, null, pageNumber,
