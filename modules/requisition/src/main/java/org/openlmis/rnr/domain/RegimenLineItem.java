...
public class RegimenLineItem extends LineItem {
  ...
  private Integer adultsInRegimenFor1MonthMale;

  private Integer adultsInRegimenFor1MonthFemale;

  private Integer childrenInRegimenFor1MonthMale;

  private Integer childrenInRegimenFor1MonthFemale;

  private Integer adultsInRegimenFor2MonthMale;

  private Integer adultsInRegimenFor2MonthFemale;

  private Integer childrenInRegimenFor2MonthMale;

  private Integer childrenInRegimenFor2MonthFemale;

  private Integer adultsInRegimenFor3MonthMale;

  private Integer adultsInRegimenFor3MonthFemale;

  private Integer childrenInRegimenFor3MonthMale;

  private Integer childrenInRegimenFor3MonthFemale;

  private Integer adultsInRegimenFor4To5MonthsMale;

  private Integer adultsInRegimenFor4To5MonthsFemale;

  private Integer childrenInRegimenFor4To5MonthsMale;

  private Integer childrenInRegimenFor4To5MonthsFemale;

  private Integer adultsInRegimenFor6MonthsMale;

  private Integer adultsInRegimenFor6MonthsFemale;

  private Integer childrenInRegimenFor6MonthsMale;

  private Integer childrenInRegimenFor6MonthsFemale;
