...
public interface RegimenLineItemMapper {
  ...
  @Update("UPDATE regimen_line_items set skipped = #{skipped}, " +
    ...
    " adultsInRegimenFor1MonthMale = #{adultsInRegimenFor1MonthMale}, " +
    " adultsInRegimenFor1MonthFemale = #{adultsInRegimenFor1MonthFemale}, " +
    " childrenInRegimenFor1MonthMale = #{childrenInRegimenFor1MonthMale}, " +
    " childrenInRegimenFor1MonthFemale = #{childrenInRegimenFor1MonthFemale}, " +
    " adultsInRegimenFor2MonthMale = #{adultsInRegimenFor2MonthMale}, " +
    " adultsInRegimenFor2MonthFemale = #{adultsInRegimenFor2MonthFemale}, " +
    " childrenInRegimenFor2MonthMale = #{childrenInRegimenFor2MonthMale}, " +
    " childrenInRegimenFor2MonthFemale = #{childrenInRegimenFor2MonthFemale}, " +
    " adultsInRegimenFor3MonthMale = #{adultsInRegimenFor3MonthMale}, " +
    " adultsInRegimenFor3MonthFemale = #{adultsInRegimenFor3MonthFemale}, " +
    " childrenInRegimenFor3MonthMale = #{childrenInRegimenFor3MonthMale}, " +
    " childrenInRegimenFor3MonthFemale = #{childrenInRegimenFor3MonthFemale}, " +
    " adultsInRegimenFor4To5MonthsMale = #{adultsInRegimenFor4To5MonthsMale}, " +
    " adultsInRegimenFor4To5MonthsFemale = #{adultsInRegimenFor4To5MonthsFemale}, " +
    " childrenInRegimenFor4To5MonthsMale = #{childrenInRegimenFor4To5MonthsMale}, " +
    " childrenInRegimenFor4To5MonthsFemale = #{childrenInRegimenFor4To5MonthsFemale}, " +
    " adultsInRegimenFor6MonthsMale = #{adultsInRegimenFor6MonthsMale}, " +
    " adultsInRegimenFor6MonthsFemale = #{adultsInRegimenFor6MonthsFemale}, " +
    " childrenInRegimenFor6MonthsMale = #{childrenInRegimenFor6MonthsMale}, " +
    " childrenInRegimenFor6MonthsFemale = #{childrenInRegimenFor6MonthsFemale}, " +
