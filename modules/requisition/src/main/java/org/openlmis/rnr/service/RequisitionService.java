...
public class RequisitionService {
  ...
  public List<Rnr> getApprovedRequisitionsForCriteriaAndPageNumber(String searchType, String searchVal, LocalDate startDate,
                                                                   LocalDate endDate, Integer pageNumber,
    ...
    List<Rnr> requisitions = requisitionRepository.getApprovedRequisitionsForCriteriaAndPageNumber(searchType, searchVal,
        startDate, endDate, pageNumber, pageSize, userId, rightName, sortBy, sortDirection);
  ...
  public Integer getNumberOfPagesOfApprovedRequisitionsForCriteria(String searchType, String searchVal, LocalDate startDate, LocalDate endDate, Long userId, String rightName) {
    Integer approvedRequisitionsByCriteria = requisitionRepository.getCountOfApprovedRequisitionsForCriteria(searchType, searchVal, startDate, endDate, userId, rightName);
    Integer pageSize = Integer.parseInt(staticReferenceDataService.getPropertyValue(CONVERT_TO_ORDER_PAGE_SIZE));
