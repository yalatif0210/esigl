...
public class OrderFtpTask {
  ...
  private static Logger logger = LoggerFactory.getLogger(OrderFtpTask.class);
  ...
  public void processOrder(@Payload List<Order> orders) {
    ...
    for (Order order : orders) {
      ...
      if (sendFtp && (supplyingFacilityFtpDetails == null || supplyingFacilityFtpDetails.getLocalFolderPath() == null)) {
      ...
      String fileName = orderFileTemplateDTO.getOrderConfiguration().getFilePrefix() + order.getId() + ".txt";
